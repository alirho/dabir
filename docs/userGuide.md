...
برای نمایش اشعار به شکل کلاسیک، می‌توانید از بلوک شعر استفاده کنید. برای ساختن آن، در یک خط `...شعر` را تایپ کنید، محتوای خود را در خطوط بعدی بنویسید و در انتها با `...` آن را ببندید. ویرایشگر به صورت خودکار هر دو خط متوالی را به عنوان یک بیت (یک مصرع در سمت راست و یک مصرع در سمت چپ) نمایش می‌دهد.
